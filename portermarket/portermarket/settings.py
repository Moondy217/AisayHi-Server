...
SECRET_KEY = 'django-insecure-1is&ais-gd^*n-ta_ybayl^3-^1aj$=-8=ja&steg4*-o++@n&'
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'user_id',  # User 모델의 기본 키 필드로 설정
    'USER_ID_CLAIM': 'user_id',  # JWT 토큰에 저장될 사용자 ID 필드명
}


AUTHENTICATION_BACKENDS = [
    'myapp.auth_backends.LoginIdBackend',  # 커스텀 백엔드
...
ROOT_URLCONF = 'portermarket.urls'
